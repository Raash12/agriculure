...
exports.deleteInventoryItem = exports.stockMovement = exports.createInventoryItem = exports.getInventory = exports.mockInventory = void 0;
...
const getInventory = async (req, res) => {
    ...
    let filtered = [...exports.mockInventory];
    if (search) {
    ...
    return res.json({
        ...
        summary: {
            ...
            lowStockCount: exports.mockInventory.filter(i => i.quantity <= i.minStockAlert).length,
            totalInventoryValueUSD: exports.mockInventory.reduce((sum, item) => sum + (item.quantity * item.unitCost), 0)
        }
    });
};
...
const createInventoryItem = async (req, res) => {
    ...
    exports.mockInventory.unshift(newItem);
...
const stockMovement = async (req, res) => {
    ...
    const item = exports.mockInventory.find(i => i.id === id);
    if (!item) {
...
const deleteInventoryItem = async (req, res) => {
    const index = exports.mockInventory.findIndex(i => i.id === req.params.id);
    if (index === -1) {
        return res.status(404).json({ success: false, error: 'Inventory item not found' });
    }
    exports.mockInventory.splice(index, 1);
